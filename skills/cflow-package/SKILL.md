...
只负责呈现和平台适配。除非包装过程暴露出核心主张不清，否则不要改内容主张；如果发现问题，只提出最小修法。硬广/软广、offer、funnel stage 和转化路径归 `$cflow-marketing`。作者人格、表达禁区和 voice profile 归 `$cflow-voice`。
...
3. 从内容中提取最可点击但真实的张力。
4. 按类型生成包装选项：标题、hook、封面文案、CTA 或平台版本。
